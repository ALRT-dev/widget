...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CreateReportProviderState&&(identical(other.dateTime, dateTime) || other.dateTime == dateTime)&&(identical(other.category, category) || other.category == category)&&(identical(other.otherCategoryName, otherCategoryName) || other.otherCategoryName == otherCategoryName)&&(identical(other.location, location) || other.location == location)&&(identical(other.description, description) || other.description == description)&&const DeepCollectionEquality().equals(other.medias, medias));
}


@override
int get hashCode => Object.hash(runtimeType,dateTime,category,otherCategoryName,location,description,const DeepCollectionEquality().hash(medias));
...
@useResult
$Res call({
 DateTime? dateTime, HazardCategory? category, String? otherCategoryName, AlrtLocation? location, String? description, List<AlrtMedia> medias
});
...
/// Create a copy of CreateReportProviderState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? dateTime = freezed,Object? category = freezed,Object? otherCategoryName = freezed,Object? location = freezed,Object? description = freezed,Object? medias = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( DateTime? dateTime,  HazardCategory? category,  String? otherCategoryName,  AlrtLocation? location,  String? description,  List<AlrtMedia> medias)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CreateReportProviderState() when $default != null:
return $default(_that.dateTime,_that.category,_that.otherCategoryName,_that.location,_that.description,_that.medias);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( DateTime? dateTime,  HazardCategory? category,  String? otherCategoryName,  AlrtLocation? location,  String? description,  List<AlrtMedia> medias)  $default,) {final _that = this;
switch (_that) {
case _CreateReportProviderState():
return $default(_that.dateTime,_that.category,_that.otherCategoryName,_that.location,_that.description,_that.medias);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( DateTime? dateTime,  HazardCategory? category,  String? otherCategoryName,  AlrtLocation? location,  String? description,  List<AlrtMedia> medias)?  $default,) {final _that = this;
switch (_that) {
case _CreateReportProviderState() when $default != null:
return $default(_that.dateTime,_that.category,_that.otherCategoryName,_that.location,_that.description,_that.medias);case _:
  return null;
...
class _CreateReportProviderState implements CreateReportProviderState {
  const _CreateReportProviderState({this.dateTime, this.category, this.otherCategoryName, this.location, this.description, final  List<AlrtMedia> medias = const <AlrtMedia>[]}): _medias = medias;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CreateReportProviderState&&(identical(other.dateTime, dateTime) || other.dateTime == dateTime)&&(identical(other.category, category) || other.category == category)&&(identical(other.otherCategoryName, otherCategoryName) || other.otherCategoryName == otherCategoryName)&&(identical(other.location, location) || other.location == location)&&(identical(other.description, description) || other.description == description)&&const DeepCollectionEquality().equals(other._medias, _medias));
}


@override
int get hashCode => Object.hash(runtimeType,dateTime,category,otherCategoryName,location,description,const DeepCollectionEquality().hash(_medias));
...
/// Create a copy of CreateReportProviderState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? dateTime = freezed,Object? category = freezed,Object? otherCategoryName = freezed,Object? location = freezed,Object? description = freezed,Object? medias = null,}) {
