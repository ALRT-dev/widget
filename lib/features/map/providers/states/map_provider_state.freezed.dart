...
/// The list of hazards displayed on the map.
 ...
 RoutePlan? get currentRoutePlan;/// Cancel token for fetching map hazards.
 CancelToken get getMapHazardsCancelToken;/// The state of fetching route.
...
@useResult
$Res call({
 List<Hazard> hazards, Hazard? selectedHazard, CameraPosition cameraPosition, Set<Marker> markers, cluster_manager.ClusterManager? clusterManager, Set<Polyline> polylines, AlrtLocation? selectedLocation, RoutePlan? currentRoutePlan, CancelToken getMapHazardsCancelToken, GetRouteState getRouteState, GetAddressFromCoordinatesState getAddressFromCoordinatesState, GetMapHazardsState getMapHazardsState, AlrtLocation? currentNavigationLocation, double currentSpeed, double currentBearing, bool isOffRoute, bool followUser, NavigationState navigationState, bool isMapReady, LatLngBounds? pendingAnimationBounds
});
...
as RoutePlan?,getMapHazardsCancelToken: null == getMapHazardsCancelToken ? _self.getMapHazardsCancelToken : getMapHazardsCancelToken // ignore: cast_nullable_to_non_nullable
as CancelToken,getRouteState: null == getRouteState ? _self.getRouteState : getRouteState // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<Hazard> hazards,  Hazard? selectedHazard,  CameraPosition cameraPosition,  Set<Marker> markers,  cluster_manager.ClusterManager? clusterManager,  Set<Polyline> polylines,  AlrtLocation? selectedLocation,  RoutePlan? currentRoutePlan,  CancelToken getMapHazardsCancelToken,  GetRouteState getRouteState,  GetAddressFromCoordinatesState getAddressFromCoordinatesState,  GetMapHazardsState getMapHazardsState,  AlrtLocation? currentNavigationLocation,  double currentSpeed,  double currentBearing,  bool isOffRoute,  bool followUser,  NavigationState navigationState,  bool isMapReady,  LatLngBounds? pendingAnimationBounds)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MapProviderState() when $default != null:
return $default(_that.hazards,_that.selectedHazard,_that.cameraPosition,_that.markers,_that.clusterManager,_that.polylines,_that.selectedLocation,_that.currentRoutePlan,_that.getMapHazardsCancelToken,_that.getRouteState,_that.getAddressFromCoordinatesState,_that.getMapHazardsState,_that.currentNavigationLocation,_that.currentSpeed,_that.currentBearing,_that.isOffRoute,_that.followUser,_that.navigationState,_that.isMapReady,_that.pendingAnimationBounds);case _:
  return orElse();
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<Hazard> hazards,  Hazard? selectedHazard,  CameraPosition cameraPosition,  Set<Marker> markers,  cluster_manager.ClusterManager? clusterManager,  Set<Polyline> polylines,  AlrtLocation? selectedLocation,  RoutePlan? currentRoutePlan,  CancelToken getMapHazardsCancelToken,  GetRouteState getRouteState,  GetAddressFromCoordinatesState getAddressFromCoordinatesState,  GetMapHazardsState getMapHazardsState,  AlrtLocation? currentNavigationLocation,  double currentSpeed,  double currentBearing,  bool isOffRoute,  bool followUser,  NavigationState navigationState,  bool isMapReady,  LatLngBounds? pendingAnimationBounds)?  $default,) {final _that = this;
switch (_that) {
case _MapProviderState() when $default != null:
return $default(_that.hazards,_that.selectedHazard,_that.cameraPosition,_that.markers,_that.clusterManager,_that.polylines,_that.selectedLocation,_that.currentRoutePlan,_that.getMapHazardsCancelToken,_that.getRouteState,_that.getAddressFromCoordinatesState,_that.getMapHazardsState,_that.currentNavigationLocation,_that.currentSpeed,_that.currentBearing,_that.isOffRoute,_that.followUser,_that.navigationState,_that.isMapReady,_that.pendingAnimationBounds);case _:
  return null;
...
/// Create a copy of MapProviderState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? hazards = null,Object? selectedHazard = freezed,Object? cameraPosition = null,Object? markers = null,Object? clusterManager = freezed,Object? polylines = null,Object? selectedLocation = freezed,Object? currentRoutePlan = freezed,Object? getMapHazardsCancelToken = null,Object? getRouteState = null,Object? getAddressFromCoordinatesState = null,Object? getMapHazardsState = null,Object? currentNavigationLocation = freezed,Object? currentSpeed = null,Object? currentBearing = null,Object? isOffRoute = null,Object? followUser = null,Object? navigationState = null,Object? isMapReady = null,Object? pendingAnimationBounds = freezed,}) {
