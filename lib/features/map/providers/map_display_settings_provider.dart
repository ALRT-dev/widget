...
enum AlertSourceSystem {
  ...
  ///
  /// Global humanitarian is tested before AWS and official: those feeds
  /// carry a source like any agency alert, so without this they would fall
  /// through to the diamond.
