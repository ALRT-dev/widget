...
import 'package:hazard_app/features/map/views/widgets/map_keys_bottomsheet_content.dart';
...
/// Shows a bottom sheet displaying the map keys.
Future<void> showMapKeysBottomSheet({
  required final BuildContext context,
}) {
  return showModalBottomSheet(
    ...
    builder: (context) => MapKeysBottomsheetContent(),
  );
}
