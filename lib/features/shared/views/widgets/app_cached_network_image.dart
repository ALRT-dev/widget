...
class AppCachedNetworkImage extends ConsumerStatefulWidget {
  /// Creates a widget that displays an image from the internet.
  ///
  /// If the [imageUrl] is present in the cache, it will be displayed immediately.
  /// Otherwise, the image will be downloaded and displayed.
  ...
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _AppCachedNetworkImageState();
}

class _AppCachedNetworkImageState extends ConsumerState<AppCachedNetworkImage> {
  @override
...
class AppCachedNetworkImageProvider extends CachedNetworkImageProvider {
  const AppCachedNetworkImageProvider._internal(
    super.url, {
    super.cacheManager,
    super.cacheKey,
  });

  static AppCachedNetworkImageProvider fromRef(
    final String url, {
    required final WidgetRef ref,
    final String? cacheKey,
  }) {
    return AppCachedNetworkImageProvider._internal(
      url,
      cacheManager: ref.watch(providerOfCacheManagerInstance),
      cacheKey: cacheKey,
    );
