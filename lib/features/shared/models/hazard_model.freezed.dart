...
@DateTimeConverter() DateTime? get reviewedAt;/// The vote type (upvote or downvote) by the current user.
 ...
 List<S3Media> get medias;/// The date and time when the hazard occurred.
...
@useResult
$Res call({
 String? id, String? title, String? description, String? shortDescription, HazardSeverity? severity, double? latitude, double? longitude, String? locationName, String? categoryId, HazardCategory? category, HazardSource? source, String? aiSummary, HazardSeverity? aiSeverity, AIConfidence? aiConfidence, AppUser? reportedBy, HazardReviewStatus? reviewStatus, String? reviewFeedback, String? reviewedById,@DateTimeConverter() DateTime? reviewedAt, HazardVoteType? userVoteType, int upvoteCount, int downvoteCount, int? confidenceScore, List<S3Media> medias,@DateTimeConverter() DateTime? occurredAt,@DateTimeConverter() DateTime? createdAt,@DateTimeConverter() DateTime? updatedAt,@DateTimeConverter() DateTime? expiresAt
});
...
/// Create a copy of Hazard
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? title = freezed,Object? description = freezed,Object? shortDescription = freezed,Object? severity = freezed,Object? latitude = freezed,Object? longitude = freezed,Object? locationName = freezed,Object? categoryId = freezed,Object? category = freezed,Object? source = freezed,Object? aiSummary = freezed,Object? aiSeverity = freezed,Object? aiConfidence = freezed,Object? reportedBy = freezed,Object? reviewStatus = freezed,Object? reviewFeedback = freezed,Object? reviewedById = freezed,Object? reviewedAt = freezed,Object? userVoteType = freezed,Object? upvoteCount = null,Object? downvoteCount = null,Object? confidenceScore = freezed,Object? medias = null,Object? occurredAt = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,Object? expiresAt = freezed,}) {
...
as List<S3Media>,occurredAt: freezed == occurredAt ? _self.occurredAt : occurredAt // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _Hazard() when $default != null:
return $default(_that.id,_that.title,_that.description,_that.shortDescription,_that.severity,_that.latitude,_that.longitude,_that.locationName,_that.categoryId,_that.category,_that.source,_that.aiSummary,_that.aiSeverity,_that.aiConfidence,_that.reportedBy,_that.reviewStatus,_that.reviewFeedback,_that.reviewedById,_that.reviewedAt,_that.userVoteType,_that.upvoteCount,_that.downvoteCount,_that.confidenceScore,_that.medias,_that.occurredAt,_that.createdAt,_that.updatedAt,_that.expiresAt);case _:
  return orElse();
...
class _Hazard extends Hazard {
  const _Hazard({this.id, this.title, this.description, this.shortDescription, this.severity, this.latitude, this.longitude, this.locationName, this.categoryId, this.category, this.source, this.aiSummary, this.aiSeverity, this.aiConfidence, this.reportedBy, this.reviewStatus, this.reviewFeedback, this.reviewedById, @DateTimeConverter() this.reviewedAt, this.userVoteType, this.upvoteCount = 0, this.downvoteCount = 0, this.confidenceScore, final  List<S3Media> medias = const <S3Media>[], @DateTimeConverter() this.occurredAt, @DateTimeConverter() this.createdAt, @DateTimeConverter() this.updatedAt, @DateTimeConverter() this.expiresAt}): _medias = medias,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Hazard&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&(identical(other.description, description) || other.description == description)&&(identical(other.shortDescription, shortDescription) || other.shortDescription == shortDescription)&&(identical(other.severity, severity) || other.severity == severity)&&(identical(other.latitude, latitude) || other.latitude == latitude)&&(identical(other.longitude, longitude) || other.longitude == longitude)&&(identical(other.locationName, locationName) || other.locationName == locationName)&&(identical(other.categoryId, categoryId) || other.categoryId == categoryId)&&(identical(other.category, category) || other.category == category)&&(identical(other.source, source) || other.source == source)&&(identical(other.aiSummary, aiSummary) || other.aiSummary == aiSummary)&&(identical(other.aiSeverity, aiSeverity) || other.aiSeverity == aiSeverity)&&(identical(other.aiConfidence, aiConfidence) || other.aiConfidence == aiConfidence)&&(identical(other.reportedBy, reportedBy) || other.reportedBy == reportedBy)&&(identical(other.reviewStatus, reviewStatus) || other.reviewStatus == reviewStatus)&&(identical(other.reviewFeedback, reviewFeedback) || other.reviewFeedback == reviewFeedback)&&(identical(other.reviewedById, reviewedById) || other.reviewedById == reviewedById)&&(identical(other.reviewedAt, reviewedAt) || other.reviewedAt == reviewedAt)&&(identical(other.userVoteType, userVoteType) || other.userVoteType == userVoteType)&&(identical(other.upvoteCount, upvoteCount) || other.upvoteCount == upvoteCount)&&(identical(other.downvoteCount, downvoteCount) || other.downvoteCount == downvoteCount)&&(identical(other.confidenceScore, confidenceScore) || other.confidenceScore == confidenceScore)&&const DeepCollectionEquality().equals(other._medias, _medias)&&(identical(other.occurredAt, occurredAt) || other.occurredAt == occurredAt)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.expiresAt, expiresAt) || other.expiresAt == expiresAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,title,description,shortDescription,severity,latitude,longitude,locationName,categoryId,category,source,aiSummary,aiSeverity,aiConfidence,reportedBy,reviewStatus,reviewFeedback,reviewedById,reviewedAt,userVoteType,upvoteCount,downvoteCount,confidenceScore,const DeepCollectionEquality().hash(_medias),occurredAt,createdAt,updatedAt,expiresAt]);
