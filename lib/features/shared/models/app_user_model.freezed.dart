...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,email,isOnboardingCompleted,profilePictureUrl,processedProfilePicture,latitude,longitude,locationName,xpPoints,reliabilityScore,hazardsViewedCount,hazardsReportedCount,upvotesReceivedCount,reportsStatus,createdAt);
