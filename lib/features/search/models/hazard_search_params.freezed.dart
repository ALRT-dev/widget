...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,searchString,const DeepCollectionEquality().hash(categoryIds),const DeepCollectionEquality().hash(sourceIds),reportedById,reviewStatus,northeastLat,northeastLng,southwestLat,southwestLng,showExpired,awsEmergency,awsWatchAndAct,awsAdvice,officialNonAws,userReported,const DeepCollectionEquality().hash(sortSettings),page,pageSize);
...
switch (_that) {
case _HazardSearchParams() when $default != null:
return $default(_that.searchString,_that.categoryIds,_that.sourceIds,_that.reportedById,_that.reviewStatus,_that.northeastLat,_that.northeastLng,_that.southwestLat,_that.southwestLng,_that.showExpired,_that.awsEmergency,_that.awsWatchAndAct,_that.awsAdvice,_that.officialNonAws,_that.userReported,_that.sortSettings,_that.page,_that.pageSize);case _:
  return orElse();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,searchString,const DeepCollectionEquality().hash(_categoryIds),const DeepCollectionEquality().hash(_sourceIds),reportedById,reviewStatus,northeastLat,northeastLng,southwestLat,southwestLng,showExpired,awsEmergency,awsWatchAndAct,awsAdvice,officialNonAws,userReported,const DeepCollectionEquality().hash(_sortSettings),page,pageSize);
